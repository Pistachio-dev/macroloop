...
namespace MacroChain {
    public sealed unsafe class MacroLoop : IDalamudPlugin {
        ...
        public MacroLoop() {
            ...
            CommandManager.AddHandler("/macroloop", new Dalamud.Game.Command.CommandInfo(OnMacroCommandHandler) {
        ...
        public void Dispose() {
            CommandManager.RemoveHandler("/macroloop");
